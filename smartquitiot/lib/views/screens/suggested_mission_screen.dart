...
import 'package:SmartQuitIoT/views/widgets/cards/mission_card.dart';

class SuggestedMissionsScreen extends StatefulWidget {
  const SuggestedMissionsScreen({super.key});

  @override
  State<SuggestedMissionsScreen> createState() =>
      _SuggestedMissionsScreenState();
}
...
class _SuggestedMissionsScreenState extends State<SuggestedMissionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalPoints = missions
        .where((m) => m['isCompleted'])
        .fold<int>(0, (sum, m) => sum + (m['points'] as int));
  ...
  void _completeMission(Map<String, dynamic> mission) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Mission "${mission['title']}" completed! +${mission['points']} points',
        ),
